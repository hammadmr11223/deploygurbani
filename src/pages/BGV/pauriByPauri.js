                    ...
                    <div className='row'>
                        ...
                        <div className='col-lg-12 p-0'>
                            <div className='in-act-wrapper'>
                                ...
                                <div className='actions-mains'>
                                    ...
                                    <button className='action-btn-main' onClick={() => window.open(`/BGV/vaar/${vaarNo}/pauri/${angNo}/print-view`, '_blank', 'height=700,width=700')}><i class="bi bi-printer"></i></button>
                        ...
                        <div className='col-lg-12 d-flex-justify-content-end ang-ang'>
                            ...
                            <div className='audio-features'>
                                ...
                                <button className='ang-btn-disable' onClick={(e) => { e.preventDefault(); navigate.push(`/bhai-gurdas-vaaran/vaar-index/${"1"}`) }}>Vaar Index</button>
