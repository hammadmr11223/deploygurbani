                            ...
                            <div className='col-lg-6 p-0'>
                                <div className='in-act-wrapper'>
                                    <div className='actions-mains'>
                                        ...
                                        <button className='action-btn-main' onClick={() => window.open(`/DGS/verse/${page_no}/print-view`, '_blank', 'height=700,width=700')}><i class="bi bi-printer"></i></button>
                                               ...
                                               {/*  <HelmetWrapper
                                                ...
                                                {isSocialShare ?
                                                    ...
                                                    <div className='socia-share' style={{ marginLeft: '600px' }}>
                                                        <ul>
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); navigate.push('/DGS/page/' + `${item.pageID}` + '/line/' + `${item.lineID}`) }}>Page View</button></li>
