        ...
        },
        {
            ...
            cell: (row) => (
                scripture === "bgv" || scripture === "ks" ?
                    ...
                    // ----- new --------- 
                    <div className='btn-dis'>
                        <button className='ang-btn-search' onClick={() => router.push('/' + row.shabadlink)}>
                            Go to page
                        </button>
                    </div> :
                    <div className='btn-dis'>
                        <button className='ang-btn-search' onClick={() => router.push('/' + row.pageLink)}>
                            Go to page
                        </button>
                    </div>
            ),
                                    ...
                                    <div className='row g-3'>
                                        <div className="col-lg-4">
                                            <div className="form-control auto-com-check">
                                                <label htmlhtmlFor="vehicle1" className='check-label'>Autocomplete</label>
                ...
                <section className='search-result common-padding' >
                    ...
                    <div className='container-lg'>
                        ...
                        <div className='search-tab-main-wrapper' >
                            <Tabs /* defaultActiveKey="Granth" */ activeKey={activeTab} id="fill-tab-example" className="mb-0" fill onSelect={handleTabSelect}>
