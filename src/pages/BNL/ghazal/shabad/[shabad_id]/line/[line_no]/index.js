                        ...
                        <div className='col-lg-6 p-0'>
                            <div className='in-act-wrapper'>
                                <div className='actions-mains'>
                                   ...
                                   {/*  <button className='action-btn-main' onClick={() => window.open(`/BNL/${type}/${shabad_id}/line/${lineno}/${headingData?.title}/print-view`, '_blank', 'height=700,width=700')}><i className="bi bi-printer"></i></button> */}
