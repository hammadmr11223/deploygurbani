                                ...
                                {authorArr.map((item, index) => (
                                    <div className='ang-itm' /* style={{ backgroundColor: index % 2 === 0 ? '#fff2ed' : 'white' }} */>
                                        ...
                                        <div className='in-act-wrapper mt-2 '>
                                            <Link href={`/GGS/ang/${item.pageno}`} className='author-para'><span>{item.raag}</span></Link>
                                            <div className='actions-mains'>
                                                <Link href={`/GGS/ang/${item.pageno}`} className='col_section_no sec-no page-no author-no'><span >{item.pageno}</span></Link>
                                            </div>
                                        </div>
                                    </div>
                                ))}
