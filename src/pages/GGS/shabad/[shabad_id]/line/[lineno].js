                                               ...
                                               {/*  {parseInt(lineno) === parseInt(item.shabdlineID) &&
                                                ...
                                                {isSocialShare ?
                                                    ...
                                                    <div className='socia-share' style={{ marginLeft: '600px' }}>
                                                        <ul>
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); navigate.push('/GGS/ang/' + `${item.pageID}` + '/line/' + `${item.lineID}`) }}>Ang View</button></li>
                                                            {/* <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); navigate.push('/GGS/verse/' + `${item.verseID}`, { state: { line: item.pagelineID } }) }}>Verse View</button></li> */}
                                                            <li>
                                                                <button
                                                                    className="ang-btn"
                                                                    onClick={(e) => {
                                                                        e.preventDefault();
                                                                        navigate.push(`/GGS/verse/${item.verseID}?line=${item.pagelineID}`);
                                                                    }}
                                                                >
                                                                    Verse View
                                                                </button>
