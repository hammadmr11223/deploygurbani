                    ...
                    <div className='row'>
                        <div className='col-lg-12 p-0'>
                            <div className='in-act-wrapper'>
                                <h1 className='inner-heading' >Sri Guru Granth Sahib Verse</h1>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className='col-lg-6 p-0'>
                                <div className='in-act-wrapper'>
                                    <div className='actions-mains'>
                                        ...
                                        <button className='action-btn-main' onClick={() => window.open(`/guru-granth-sahib/verse/${page_no}/print-view`, '_blank', 'height=700,width=700')} ><i class="bi bi-printer"></i></button>
                            ...
                            {isSplitView === false ?
                                                ...
                                                {isSocialShare ?
                                                    ...
                                                    <div className='socia-share' style={{ marginLeft: '600px' }}>
                                                        <ul>
                                                            ...
                                                            <li><button className='ang-btn' onClick={(e) => { e.preventDefault(); navigate('/guru-granth-sahib/shabad/' + `${item.shabdID}` + '/line/' + `${item.shabdlineID}`) }}>Shabad View</button></li>
                                ...
                                <div className='ang-wrapper' ref={textContainerRef}>
                                    ...
                                    {isManmohanTransln ?
                                        <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                            {angData.map((item, index) => (
                                                <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.eng_mms}</div>
                                            ))}
                                        </div> : null}
                                    {isPunjabiTransln ?
                                        <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                            {angData.map((item, index) => (
                                                <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.punj_mms}</div>
                                            ))}
                                        </div> : null}
                                    {isGuruGranthTeeka ?
                                        <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                            {angData.map((item, index) => (
                                                <>
                                                <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.ss_line}</div>
                                                <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.ss_pad}</div></>
                                            ))}
                                        </div> : null}
                                    {isFaridkotTeeka ?
                                        <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                            {angData.map((item, index) => (
                                                <>
                                                    <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.fwt}</div>
                                                    <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.fwt_2}</div>
                                                    <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.fwt_3}</div>
                                                </>
                                            ))}
                                        </div> : null}
                                    {isFaridkotaTeekaHindi ?
                                        <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                            {angData.map((item, index) => (
                                                <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.fwt_hindi}</div>
                                            ))}
                                        </div> : null}
                                    {isSgpcTeeka ?
                                        <div className={`ang-itm ${isCenter && 'center-align'} ${isDarkMode && 'dark-mode'}`} >
                                            {angData.map((item, index) => (
                                                <>
                                                    <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.sgpc_1}</div>
                                                    <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.sgpc_2}</div>
                                                    <div style={{ fontSize: `${englishSize}px`, color: englishColor }} >{item.sgpc_3}</div>
                                                </>
                                            ))}
                                        </div> : null}
                                    {isAttrib ?
