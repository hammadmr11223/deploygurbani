...
function CompilationSGGS() {
   // const navigate = useNavigate();
    ...
    useEffect(() => {
        getCompilation(pageno)
        setAngNo(pageno)
    }, [pageno])
    const getCompilation = async (page) => {
        setLoader(true)
        await Axios.get(API.getCompilation + '?page=' + page + '&volume_id=0&lang=')
            .then((resData) => {
                setLoader(false)
    ...
    return (
        <div>
            {loader && <Spinner />}
          {/*   <HelmetWrapper
                title={`Compilation of Sri Guru Granth Sahib`}
            ...
            <section className='inner-actions p-4' >
                    ...
                    <div className='row'>
                        <div className='col-lg-12 p-0'>
                            <div className='in-act-wrapper'>
                                <h1 className='inner-heading-music' >
                                    Compilation of Sri Guru Granth Sahib</h1>
                        ...
                        <div className='col-lg-12 d-flex-justify-content-end ang-ang  mt-3'>
                                    ...
                                    <span className='slider'></span> */}
                                        <div className='go-to-ang position-relative'>
                                            <div className='form-group'>
                                                ...
                                                />
                                                <button className='ang-btn' onClick={(e) => { e.preventDefault(); getCompilation(angNo); }}>Go</button>
                                            </div>
                                        </div>
                                    </label>
                                </div>
                            ...
                            <div className='go-line-wrapper' >
                                ...
                                <div className='navigation-btn-audio'>
                                    ...
                                    <button className='ang-btn' style={{ background: 'var(--current-color, var(--color-1))', color: '#fff' }} onClick={() => navigate(`/compilation/page/${1}`)}>Book Index</button>
                ...
                <div className='center-align'><b>Displaying Page {headingData.page_no} of 271</b></div>

            </section>

            <section className='inner-actions p-4' >
                <div className='container index-wrp Compilation'>
                ...
                {/* <div className='row'>
                        ...
                        <div className='d-flex flex-column'>
                            <div className='ang-display mt-5'>
                                <h1>Displaying Page 1 of 271</h1>
...
export default CompilationSGGS