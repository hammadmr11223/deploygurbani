...
const BnlPages = (props) => {
    ...
    const url = `/BNL/${props.apiName}/shabad/${item.shabadID}/line/${item.shabadlineID}`;
    router.push(url);
  };
    ...
    // Navigate to dynamic route
   const url = `/BNL/${props.apiName}/verse/${item.verseID}?line=${item.lineno}`;
    router.push(url);
  };
                        ...
                        <div className='col-lg-12 p-0'>
                            <div className='in-act-wrapper'>
                                ...
                                <div className='actions-mains'>
                                    ...
                                    <button className='action-btn-main' onClick={() => window.open(`/BNL/${props.apiName}/page/${angNo}/print-view`, 'Bhai Nand Lal', '_blank', 'height=700,width=700')}><i class="bi bi-printer"></i></button>
